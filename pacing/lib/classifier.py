...
#         # ----------------------------------
#         self.fc5 = torch.nn.Linear(128, nc)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, input_ch=3, num_classes=10, zero_init_residual=False,
...
def _resnet(arch, block, layers, pretrained, progress, device, **kwargs):
    ...
    if pretrained:
        script_dir = '/home/jupyter-eaa418/new/checkpoint/resnet18.pt'
